  ...
  return (
    <section
      ...
      style={{
        ...
        // Clears the fixed header *and* the iPhone status bar / notch.
        paddingTop: 'calc(4rem + env(safe-area-inset-top))',
      }}
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10 w-full py-20 lg:py-0">
        <div className="grid lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_480px] gap-12 lg:gap-20 items-center lg:min-h-[calc(100vh-64px)]">
          {/* Content */}
          <div className="flex flex-col justify-center order-2 lg:order-1">
            <p
              className="hero-item text-xs font-semibold tracking-[0.2em] uppercase mb-6"
            ...
            <h1
              className="hero-item font-serif font-bold leading-none mb-4"
              data-visible={entered}
              style={{ color: '#102A43', fontSize: 'clamp(52px, 8vw, 96px)', transitionDelay: delay(1) }}
            >
              EUCHARIA<br />
              EMERIE MBA
            </h1>
            ...
            <p
              className="hero-item text-lg font-medium mb-5"
              data-visible={entered}
            ...
            <p
              className="hero-item text-base leading-relaxed mb-10"
              data-visible={entered}
            ...
            >
              <button
                onClick={onViewCV}
                className="px-7 py-3.5 rounded-full text-white font-semibold text-sm transition-all duration-200 hover:opacity-90 hover:shadow-lg"
              ...
              <a
                ...
                className="px-7 py-3.5 rounded-full font-semibold text-sm border transition-all duration-200 hover:bg-navy hover:text-white"
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            ...
            <div className="lg:hidden w-full max-w-xs mx-auto">
              <div
                className="hero-portrait w-full rounded-2xl overflow-hidden"
                data-visible={entered}
                style={{ aspectRatio: '4 / 5', backgroundColor: '#F4F2ED' }}
              >
                <img
                  src={portrait.src}
                  alt={portrait.alt}
